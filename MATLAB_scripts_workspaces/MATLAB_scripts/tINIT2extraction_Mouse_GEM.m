cd '/Users/rokosango/PhD/Modelling/Human-GEM/data/metabolicTasks'
...
cd '/Users/rokosango/cobratoolbox/test/models/mat'
load('Mouse-GEM.mat')
...
% saving to .mat files
 save('ControlModel','ControlModel')
 save('LPSModel','LPSModel')
 save('IL4Model','IL4Model')
